...
DISABLE_SHARED_NOTES = config('SHARED_NOTES_DISABLED', cast=bool, default=False)
SHARED_NOTES_PASSWORD_REQUIRED = config('SHARED_NOTES_PASSWORD_REQUIRED', cast=bool, default=False)
SHARED_NOTES_READONLY_REQUIRED = config('SHARED_NOTES_READONLY_REQUIRED', cast=bool, default=False)
