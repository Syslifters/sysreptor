...
from reportcreator_api.pentests.models import PentestFinding, PentestProject, ProjectType, UploadedAsset, UploadedImage, \
    ...
    ArchivedProjectKeyPart, ArchivedProjectPublicKeyEncryptedKeyPart, UploadedTemplateImage, ReportSection, OperationalTransformationEvent
...
class Command(BaseCommand):
    ...
    def encrypt_data(self):
        ...
        self.encrypt_db_fields(OperationalTransformationEvent, ['data'])
