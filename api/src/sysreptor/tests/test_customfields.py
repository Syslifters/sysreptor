...
@pytest.mark.parametrize(('valid', 'definition'), [
    ...
    (True, [
        ...
        {'id': 'field_json', 'type': 'json', 'label': 'JSON Field', 'default': None, 'schema': None},
        {'id': 'field_json_schema', 'type': 'json', 'label': 'JSON Field with Schema', 'default': '{}', 'schema': {'type': 'object'}},
    ...
    (False, [{'id': 'f', 'type': 'json', 'label': 'JSON Field', 'default': {}}]),
    (False, [{'id': 'f', 'type': 'json', 'label': 'JSON Field', 'schema': 'not an object'}]),
