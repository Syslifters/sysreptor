...
class PeriodicTaskQuerySet(models.QuerySet):
    async def get_pending_tasks(self):
        from sysreptor.tasks.models import PeriodicTaskInfo, TaskStatus, periodic_task_registry
...
class PeriodicTaskManager(models.Manager.from_queryset(PeriodicTaskQuerySet)):
    async def run_task(self, task_info):
        from sysreptor.tasks.models import PeriodicTask, PeriodicTaskInfo, TaskStatus
