    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_key', sysreptor.utils.crypto.fields.EncryptedField(base_field=models.CharField(max_length=40, verbose_name='session key'), editable=True)),
                ('session_data', sysreptor.utils.crypto.fields.EncryptedField(base_field=models.TextField(verbose_name='session data'), editable=True)),
            ...
            managers=[
                ('objects', sysreptor.users.querysets.SessionManager()),
            ],
        ),
        migrations.AddField(
            model_name='pentestuser',
            name='password_new',
            field=sysreptor.utils.crypto.fields.EncryptedField(base_field=models.CharField(max_length=128, default='', verbose_name='password'), editable=True),
        ...
        migrations.AlterField(
            model_name='pentestuser',
            name='password',
            field=sysreptor.utils.crypto.fields.EncryptedField(base_field=models.CharField(max_length=128, verbose_name='password'), editable=True),
        ),
    ]
