...
then
    ...
    then
        ...
        echo "Warning: cron is not installed. Skipping automatic updates."
        echo "Install cron, or schedule updates manually:"
        echo "See: https://docs.sysreptor.com/setup/updates"
    fi
fi
