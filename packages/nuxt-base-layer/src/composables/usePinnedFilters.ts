...
export function usePinnedFilters() {
  function getPinnedFilters(): string[] {
    try {
      ...
      console.debug('[base usePinnedFilters] getPinnedFilters', p);
      return p;
    } catch {
      return [];
    }
  ...
  function setPinnedFilters(filters: string[]) {
    ...
    console.debug('[base usePinnedFilters] setPinnedFilters', filters);
  }
  ...
  function unpinFilter(id: string) {
    ...
    console.debug('[base usePinnedFilters] unpinFilter', { id, before, after });
  }
  ...
  function restorePinnedFilters(filterProperties: any[]): any[] {
    ...
    console.debug('[base usePinnedFilters] restorePinnedFilters', { filterProperties, pinned, restored });
    return restored;
  }
