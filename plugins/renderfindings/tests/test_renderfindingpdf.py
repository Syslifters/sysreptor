...
URL_NAMESPACE = RenderFindingPdfPluginConfig.label
...
class TestRenderSingleFindingPdf:
    ...
    def render_html(self, findings, template=None):
        ...
        with mock.patch('reportcreator_api.tasks.rendering.render.render_pdf_impl', render_only_html):
            res = self.client.post(reverse(f'{URL_NAMESPACE}:renderfindingspdf', kwargs={'project_pk': self.project.id}), data={
    ...
    @pytest.mark.parametrize(['template', 'expected'], [
        ...
        ('<div data-sysreptor-renderfindingpdf="include">include</div><div>exclude</div>', '<div data-sysreptor-renderfindingpdf="include">include</div>'),
        ('<div data-sysreptor-renderfindingpdf="exclude">exclude</div>', ''),
        ('<div data-sysreptor-renderfindingpdf="include">include <div data-sysreptor-renderfindingpdf="exclude">exclude</div></div>', '<div data-sysreptor-renderfindingpdf="include">include </div>'),
        ('<div data-sysreptor-renderfindingpdf="exclude">exclude <div data-sysreptor-renderfindingpdf="include">include</div></div>', ''),
